...
export const drmartensHeaderSelectors: DeepPartial<Selectors> = {
  header: {
    searchInput: 'input[type="search"]:visible, input[name="q"]:visible, [data-testid="search-input"]:visible, input[placeholder*="search" i]:visible, input[placeholder*="looking for" i]:visible',
